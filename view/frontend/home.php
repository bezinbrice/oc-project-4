    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <img src="web/images/gilbert-garcin-photographe-sur-le-tard.jpg" class="rounded mx-auto d-block image-home-hero" alt="portrait de Gilbert Garcin">
...
<div class="container home-page">
    <div class="row">
        <div class="col-md-12">
            ...
            ?>
            <div>
                <img src="web/images/les-amoureux-de-peros-guirec-gilbert-garcin.jpg"  class="rounded mx-auto d-block" alt="...">
            </div>
            <div class="card home--pitch-card">
                ...
                <div class="card-body">
                    ...
                    <a href="index.php?action=listPosts" class="btn btn-primary">Aller à la page des chapitres</a>
                </div>
            </div>
        </div>
    </div>
